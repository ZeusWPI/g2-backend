...
;;; We copy over the exception middleware of reitit here.
;;; This is so we can extend the main wrap function that executes the handler and wraps it with a try.
  ...
  (create-exception-middleware
    (merge
      ...
      {;; ex-data with :type ::error
       ...
       java.sql.SQLIntegrityConstraintViolationException (partial handler "sql-constraint-violation")
