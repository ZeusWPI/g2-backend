...
docker-staging:
	...
	sudo docker run -it -p "3333:3000" -e "DATABASE_URL=mysql://host.docker.internal:3306/g2_dev?user=g2_dev_user&password=mstFVVS4ASEDMZlx0TWsWABmo&serverTimezone=UTC" --name g2-backend g2-backend-img /bin/bash
